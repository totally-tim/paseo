...
The permanent fork does not build or publish Docker images in GitHub Actions. Use the local
build commands above for Docker work. Treat registry publication as a separate operation that
