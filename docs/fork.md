...
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Resident project and global coordinators                         | `packages/server/src/server/coordinator`, `packages/app/src/coordinator`; protocol, client, agent, schedule and workspace integration                                                                                                                                                   | Fork product surface with provider-enforced delegation and daemon-owned automation; see [coordinators](coordinator.md)                                                                                                          |
...
| Kanban board plugin example and the host hooks it needs          | `plugin-examples/inbox`; small hooks in `packages/app/src/plugins`, `packages/client`, `packages/plugin`; `requestedAt` on pending permission requests and the `permissionRequestedAt`, `checkoutInspection`, `scheduleList` feature flags in `packages/protocol` and `packages/server` | Fork-side experiment, not offered upstream                                                                                                                                                                                      |
