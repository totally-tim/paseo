...
- **Follow [the hover pattern](hover.md).** Pointer enter/leave handlers on a plain web `View` track hover; native and compact layouts keep controls visible without hover.
