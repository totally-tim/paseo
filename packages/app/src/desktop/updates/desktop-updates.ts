...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/totally-tim/paseo/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Forkeo-${normalizedVersion}-arm64.dmg`;
}
