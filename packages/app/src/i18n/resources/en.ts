export const en = {
  ...
  providerAccounts: {
    ...
    retainCredentials: "Keep the provider login",
    logoutCredentials: "Sign out of this account",
    ...
    missingAccount: "Unavailable account",
    next: "Next automatic start: {{account}}",
    loadError: "Could not load account usage. Retry when the host is connected.",
    ...
    resetCredits_one: "{{count}} reset credit",
    resetCredits_other: "{{count}} reset credits",
    resetCreditExpires: "earliest expires {{at}}",
    useResetCredit: "Use reset",
    useResetCreditConfirm:
      "Spend one reset credit on {{account}}? Codex applies it immediately and it cannot be undone.",
    resetCreditApplied: "Rate limits reset.",
    resetCreditUnconfirmed: "Reset reported, but the usage refresh could not confirm it yet.",
    resetCreditNothing: "Nothing to reset — this account is not rate-limited.",
    resetCreditNone: "No reset credit is available on this account.",
    resetCreditUsed: "That reset credit was already redeemed.",
    resetCreditFailed: "Could not use the reset credit.",
    pooledAccounts_one: "{{count}} account",
    pooledAccounts_other: "{{count}} accounts",
    pooledDuplicates_one: "{{count}} duplicate hidden",
    pooledDuplicates_other: "{{count}} duplicates hidden",
    pooledRemaining: "{{pct}} left",
    pooledRefill: "+{{pct}} in {{in}}",
    paceOnPace: "on pace",
    paceFast: "burning fast",
    paceSlow: "under pace",
    auth: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Forkeo worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Forkeo start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Forkeo could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Forkeo",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Forkeo under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Forkeo notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Forkeo CLI.",
      },
    },
  },
  rootError: {
    title: "Forkeo ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Forkeo server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Forkeo daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Forkeo relay works",
      ...
      updateRequired: "Update the host to enable relay from Forkeo Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Forkeo on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Forkeo {{count}} time",
      other: "called Forkeo {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  coordinator: {
    board: {
      ...
      yoursGoal: "Yours: {{goal}}",
      linkSession: "session",
      nothingWorking: "Nothing working",
      nothingDone: "Nothing done yet",
      unavailable: "The coordinator board isn't available for this project.",
      sessionStarting: "The coordinator is starting…",
      peekTitle: "Decision",
    },
    ...
    trust: {
      ...
      hints: {
        observe: "Reads and asks. Spawns nothing.",
        propose: "May spawn read-only investigators and reviewers.",
        ship: "May spawn worktree implementers and open change requests.",
        autopilot: "Ship, plus merging its own change requests under the merge policy.",
      },
      allowAutopilot: "Allow autopilot in this project",
      usage: {
        spawns: "{{count}} spawns",
        spawnsExpected: "{{used}} of {{expected}} spawns expected",
        tokens: "{{used}} tokens",
        tokensExpected: "{{used}} of {{expected}} tokens expected",
      },
    },
    scope: {
      title: "Scope",
      ...
      everythingHint: "Watches every workspace, including your own sessions.",
      projectOnlyHint: "Your own sessions stay out of Working and out of proposals.",
    },
    setup: {
      rowLabel: "Set up a coordinator",
      ...
      enable: "Enable",
      noCi: "This repository has no CI, so the CI watch has nothing to poll. The PR watch still works.",
      addCi: "Ask the coordinator to add CI",
      ciQueued: "The coordinator will be asked when it starts.",
      ciComposerSeed: "Set up CI for this repository.",
    },
  },
  settings: {
    title: "Settings",
    ...
    notifications: {
      ...
      sentDescription: "Forkeo handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Forkeo uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Forkeo picks a fast available model",
      preferredHint: "Choose the model Forkeo uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Forkeo falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Forkeo.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Forkeo on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Forkeo skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Forkeo skills?",
        uninstallMessage:
          "Removes all Forkeo orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Forkeo reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Forkeo reconnects automatically-try again once the host shows as online.",
          dialogFailedMessage: "Unable to open the restart confirmation dialog.",
        },
        update: {
          desktopManagedHint:
            "This daemon is managed by Forkeo Desktop. Update Forkeo Desktop on the host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Forkeo supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Forkeo uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
