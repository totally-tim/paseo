...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    terminal: {
      hostDisconnected: "Host no está conectado",
  ...
  sidebar: {
    ...
    project: {
      ...
      group: {
        ...
        ungroup: "Desagrupar proyectos",
        ungrouping: "Desagrupando...",
        headerMenu: "Acciones del grupo",
        updateHost: "Actualiza el host para usar grupos",
        hostDisconnected: "Host no está conectado",
        failed: "No se pudo actualizar el grupo",
      },
      confirmations: {
