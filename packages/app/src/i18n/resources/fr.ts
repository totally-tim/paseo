...
export const fr: TranslationResources = {
  ...
  agentHandoff: {
    ...
    description:
      "Ouvrez une nouvelle conversation dans cet espace avec le contexte enregistré. L’agent actuel s’arrêtera. Choisir un autre fournisseur lui transmet ce contexte.",
    model: "Fournisseur et modèle",
    mode: "Mode d’autorisation",
    defaultMode: "Valeur par défaut du fournisseur",
    continue: "Démarrer la suite",
    source: "Conversation précédente",
    successor: "Ouvrir la suite",
    stopped: "Continuation demandée",
    briefing: "Instructions supplémentaires (facultatif)",
    thinking: "Raisonnement : {{value}}",
  },
  common: {
    back: "Dos",
    loading: "Chargement...",
  ...
  workspace: {
    ...
    terminal: {
      hostDisconnected: "Host n'est pas connecté",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travail Forkeo",
          mergePrNoForge:
  ...
  sidebar: {
    ...
    project: {
      ...
      group: {
        ...
        renaming: "Renommage...",
        ungroup: "Dégrouper les projets",
        ungrouping: "Dégroupement...",
        headerMenu: "Actions du groupe",
        updateHost: "Mettez à jour le host pour utiliser les groupes",
        hostDisconnected: "Host n'est pas connecté",
        failed: "Impossible de mettre à jour le groupe",
      },
      confirmations: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Laissez Forkeo démarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, mais Forkeo n'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittez Forkeo",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionIntelde Forkeo sousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notification Forkeo",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer le Forkeo CLI.",
      },
    },
  },
  rootError: {
    title: "Forkeo a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveur Forkeo.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Forkeo sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Forkeo",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Forkeo Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavec Forkeo sur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé Forkeo {{count}} fois",
      other: "a appelé Forkeo {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  contextWindow: {
    ...
    lastRequest: "Dernière requête au modèle",
    input: "Entrée : {{tokens}} tokens",
    cachedInput: "En cache : {{tokens}} tokens",
    cacheHit: "En cache : {{tokens}} tokens ({{percentage}} %)",
    cacheNotReported: "Cache : non indiqué",
    uncachedInput: "Hors cache : {{tokens}} tokens",
    output: "Sortie : {{tokens}} tokens",
    reasoning: "Dont raisonnement : {{tokens}} tokens",
    firstToken: "Premier token : {{seconds}} s",
    generationSpeed: "Débit observé : ~{{speed}} tokens/s",
    generationHint: "De la première sortie à la fin ; raisonnement inclus.",
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Forkeo a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Forkeo pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Forkeo choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Forkeo",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Forkeo utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Forkeo.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jour Forkeo sur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétences Forkeo?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétences Forkeo?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestration Forkeo de ~/.agents, ~/.claude, ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Forkeo se reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Forkeo se reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Forkeo Desktop. Mettez à jour Forkeo Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Forkeo supervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA que Forkeo utilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
