...
export const ja: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはForkeoワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "Forkeoが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、Forkeoがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、Forkeoがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "Forkeoを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでForkeoのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Forkeo CLIをインストールできません。",
      },
    },
  },
  rootError: {
    title: "Forkeo で問題が発生しました。",
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "Forkeoサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    remoteSsh: {
      title: "リモート SSH",
      helper: "リモートホストで動作する Forkeo デーモンに接続します。",
      fields: {
        target: "SSH ホスト",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "Forkeo リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "Forkeo Desktop からリレーを有効にするにはホストを更新してください。",
      unavailable: "ペアリングオファーが利用できません。",
      hint: "スマートフォンのForkeoでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "Forkeoを{{count}}回呼び出し",
      other: "Forkeoを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Forkeo が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "Forkeo が利用可能な高速モデルを選択します",
      preferredHint: "Forkeo が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、Forkeo は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのForkeoを更新します",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Forkeoスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "Forkeoスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのForkeoオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Forkeoツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "Forkeoツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。Forkeoが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。Forkeoは自動的に再接続します。ホストがオンラインになったら再試行してください。",
          dialogFailedMessage: "再起動確認ダイアログを開けませんでした。",
        },
        update: {
          desktopManagedHint:
            "このデーモンはForkeo Desktopによって管理されています。ホスト上のForkeo Desktopを更新してください。",
          title: "デーモンを更新",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Forkeoがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "Forkeoがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
