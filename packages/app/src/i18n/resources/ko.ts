...
export const ko: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "이 워크스페이스가 Forkeo 워크트리로 생성되지 않아 여기서 보관을 사용할 수 없습니다",
          mergePrNoForge:
  ...
  sidebar: {
    ...
    project: {
      ...
      group: {
        ...
        renaming: "이름 변경하는 중...",
        ungroup: "프로젝트 그룹 해제",
        ungrouping: "그룹 해제하는 중...",
        headerMenu: "그룹 작업",
        updateHost: "그룹을 사용하려면 호스트를 업데이트하세요",
        hostDisconnected: "호스트가 연결되어 있지 않습니다",
        failed: "그룹을 업데이트할 수 없습니다",
      },
      confirmations: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "내장 데몬 관리",
        hint: "Forkeo가 내장 데몬을 시작하고 중지하도록 허용합니다",
        pauseTitle: "내장 데몬 일시 중지",
        pauseMessage:
          "내장 데몬이 즉시 중지됩니다. 내장 데몬에 연결된 실행 중인 에이전트와 터미널이 중지됩니다.",
        pauseAndStop: "일시 중지 후 중지",
        registrationFailed:
          "내장 데몬이 시작되었지만 Forkeo가 localhost 연결을 저장하지 못했습니다. 데몬 관리를 껐다가 다시 켜거나 localhost를 수동으로 추가하세요.",
        pausedStopFailed: "내장 데몬 관리가 일시 중지되었지만 Forkeo가 데몬을 중지하지 못했습니다.",
        updateFailed: "내장 데몬 관리를 업데이트할 수 없습니다.",
      },
      keepRunning: {
        title: "종료 후에도 데몬 계속 실행",
        hint: "Forkeo를 종료해도 데몬이 계속 실행됩니다",
      },
      logs: {
        title: "로그 파일",
        modalTitle: "데몬 로그",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon에서 Rosetta로 Forkeo의 Intel 빌드를 실행하고 있습니다.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Forkeo CLI를 설치할 수 없습니다.",
      },
    },
  },
  rootError: {
    title: "Forkeo에 문제가 발생했습니다.",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "원격 SSH",
      helper: "원격 호스트에서 실행 중인 Forkeo 데몬에 연결합니다.",
      fields: {
        target: "SSH 호스트",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "릴레이 작동 방식",
      relayDocsAccessibility: "Forkeo 릴레이 작동 방식 읽기",
      enableRelay: "릴레이 활성화",
      enablingRelay: "활성화 중...",
      notNow: "지금은 아님",
      directConnectionHint:
        "릴레이 없이 TCP, Tailscale 또는 다른 VPN을 통해 직접 연결하세요. QR 코드가 생성되지 않습니다.",
      updateRequired: "Forkeo 데스크톱에서 릴레이를 활성화하려면 호스트를 업데이트하세요.",
      unavailable: "페어링 정보를 사용할 수 없습니다.",
      hint: "휴대폰의 Forkeo로 이 QR 코드를 스캔하거나 아래 링크를 복사하세요.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "Forkeo를 {{count}}회 호출함",
      other: "Forkeo를 {{count}}회 호출함",
    },
    and: "그리고",
  },
  renameModal: {
  ...
  contextWindow: {
    ...
    lastRequest: "최근 모델 요청",
    input: "입력: {{tokens}} 토큰",
    cachedInput: "캐시: {{tokens}} 토큰",
    cacheHit: "캐시: {{tokens}} 토큰 ({{percentage}}%)",
    cacheNotReported: "캐시: 보고되지 않음",
    uncachedInput: "캐시되지 않음: {{tokens}} 토큰",
    output: "출력: {{tokens}} 토큰",
    reasoning: "그중 추론: {{tokens}} 토큰",
    firstToken: "첫 토큰: {{seconds}}초",
    generationSpeed: "관측 출력: 약 {{speed}} 토큰/초",
    generationHint: "첫 출력부터 완료까지 측정하며 추론을 포함합니다.",
  },
  review: {
    comment: {
      add: "리뷰 댓글 추가",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Forkeo가 알림을 운영 체제에 전달했습니다.",
    ...
    metadataGeneration: {
      ...
      automatic: "자동",
      preferred: "수동",
      automaticHint: "Forkeo가 사용 가능한 빠른 모델을 선택합니다",
      preferredHint: "Forkeo에서 사용할 모델을 선택하세요",
      model: "모델",
      fallbackHint: "사용할 수 없으면 Forkeo가 다른 사용 가능한 모델을 사용합니다",
      docs: "문서",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "브라우저 탭은 Forkeo 전체에서 로그인 및 사이트 데이터를 공유합니다.",
        clear: "브라우저 데이터 지우기",
        clearing: "삭제 중...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "이 컴퓨터의 Forkeo를 업데이트합니다",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Forkeo 스킬을 업데이트할까요?",
        updateFallback: "번들된 스킬을 내 컴퓨터에 동기화합니다.",
        uninstallTitle: "Forkeo 스킬을 제거할까요?",
        uninstallMessage:
          "~/.agents, ~/.claude, ~/.codex에서 모든 Forkeo 오케스트레이션 스킬을 제거합니다.",
        choose: "스킬 선택",
        chooseAll: "모든 스킬",
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "Forkeo 도구 주입",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "이 호스트는 오프라인입니다. Forkeo가 자동으로 다시 연결하므로 다시 온라인이 될 때까지 기다린 후 재시작하세요.",
          requestFailedTitle: "오류",
          requestFailedMessage:
            "재시작 요청을 보내지 못했습니다. Forkeo가 자동으로 다시 연결하므로 호스트가 온라인으로 표시되면 다시 시도하세요.",
          dialogFailedMessage: "재시작 확인 대화 상자를 열 수 없습니다.",
        },
        update: {
          desktopManagedHint:
            "이 데몬은 Forkeo Desktop에서 관리됩니다. 호스트에서 Forkeo 데스크톱을 업데이트합니다.",
          title: "데몬 업데이트",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Forkeo가 프로세스를 감독하고 $PASEO_PORT를 통해 포트를 할당합니다",
        actions: {
          add: "스크립트 추가",
          edit: "편집",
          remove: "제거",
      ...
      metadata: {
        title: "메타데이터 생성",
        info: "Forkeo가 메타데이터를 생성하는 데 사용하는 AI 프롬프트에 주입되는 프로젝트별 지침 - 브랜치 이름, 커밋 스타일, PR 형식 같은 팀 규칙을 적용하는 데 사용하세요",
        branchName: "브랜치 이름",
