...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree Forkeo.",
  ...
  desktop: {
    ...
    quitting: {
      title: "Завершение работы Forkeo...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить Forkeo запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но Forkeo не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но Forkeo не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из Forkeo",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку Forkeo для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить Forkeo CLI.",
      },
    },
  },
  rootError: {
    title: "В Forkeo возникла проблема.",
  ...
  onboarding: {
    title: "Добро пожаловать в Forkeo",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера Forkeo.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону Forkeo на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор Forkeo",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из Forkeo Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Отсканируйте этот QR-код с помощью Forkeo на телефоне или скопируйте ссылку ниже.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "выполнен {{count}} вызов Forkeo",
      other: "выполнены вызовы Forkeo ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Forkeo передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую Forkeo будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "Forkeo выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует Forkeo",
      model: "Модель",
      fallbackHint: "Если она недоступна, Forkeo использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в Forkeo используют общие данные входа и данные сайтов.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать Forkeo.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит Forkeo на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки Forkeo?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки Forkeo?",
        uninstallMessage:
          "Удаляет все навыки оркестрации Forkeo из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты Forkeo",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты Forkeo",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. Forkeo переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. Forkeo переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint:
            "Этот демон управляется Forkeo Desktop. Обновите Forkeo Desktop на хосте.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Forkeo управляет процессом и назначает порт через переменную $PASEO_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых Forkeo генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
