...
export const zhCN: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 workspace 不是作为 Forkeo worktree 创建的",
  ...
  sidebar: {
    ...
    project: {
      ...
      group: {
        ...
        renameConfirm: "重命名",
        renaming: "正在重命名...",
        ungroup: "取消 project 分组",
        ungrouping: "正在取消分组...",
        headerMenu: "分组操作",
        updateHost: "更新 host 以使用分组",
        hostDisconnected: "Host 未连接",
        failed: "无法更新分组",
      },
      confirmations: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 Forkeo 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 Forkeo 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 Forkeo 无法停止 daemon。",
        updateFailed: "无法更新内置 daemon 管理设置。",
      },
      keepRunning: {
        title: "退出后保持 daemon 运行",
        hint: "退出 Forkeo 后 daemon 会继续运行",
      },
      logs: {
        title: "日志文件",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 Forkeo 的 Intel 构建。",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "远程 SSH",
      helper: "连接到远程主机上运行的 Forkeo 守护进程。",
      fields: {
        target: "SSH 主机",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "中继如何工作",
      relayDocsAccessibility: "阅读 Forkeo 中继的工作原理",
      enableRelay: "启用中继",
      enablingRelay: "正在启用...",
      notNow: "暂不",
      directConnectionHint:
        "不使用中继时，请通过 TCP、Tailscale 或其他 VPN 直接连接。不会生成二维码。",
      updateRequired: "请更新主机，以便从 Forkeo Desktop 启用中继。",
      unavailable: "配对 offer 不可用。",
      hint: "用手机上的 Forkeo 扫描此二维码，或复制下方链接。",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "调用了 Forkeo {{count}} 次",
      other: "调用了 Forkeo {{count}} 次",
    },
    and: "并",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sending: "正在发送...",
      sentTitle: "测试通知已发送",
      sentDescription: "Forkeo 已将通知交给操作系统。",
    ...
    metadataGeneration: {
      title: "元数据生成",
      description: "选择 Forkeo 用于工作区标题、分支名称、提交消息和拉取请求草稿的模型",
      selection: "模型选择",
      automatic: "自动",
      preferred: "手动",
      automaticHint: "Forkeo 会选择一个可用的快速模型",
      preferredHint: "选择 Forkeo 使用的模型",
      model: "模型",
      fallbackHint: "如果不可用，Forkeo 会改用其他可用模型",
      docs: "文档",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "浏览器标签页在 Forkeo 中共享登录状态和网站数据。",
        clear: "清除浏览器数据",
        clearing: "正在清除...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "这会更新此电脑上的 Forkeo",
        installConfirm: "安装更新",
        update: "更新",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "更新 Forkeo skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 Forkeo skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 Forkeo 编排 skills。",
        choose: "选择 skills",
        chooseAll: "全部 skills",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "启用 Forkeo tools",
          hint: "Agent 将能够管理 worktree、Agent 和计划",
          accessibilityLabel: "注入 Forkeo tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。Forkeo 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage: "发送重启请求失败。Forkeo 会自动重连，请在 Host 显示在线后重试。",
          dialogFailedMessage: "无法打开重启确认对话框。",
        },
        update: {
          desktopManagedHint: "此 Daemon 由 Forkeo Desktop 管理。请在 Host 上更新 Forkeo Desktop。",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "Forkeo 会监管该进程，并通过 $PASEO_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 Forkeo 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
