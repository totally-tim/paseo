...
async function launch(
  ...
  try {
    ...
    chmodSync(join(app, "Forkeo"), 0o755);
    ...
    const executablePath = options.symlink ? join(root, "paseo") : join(app, "Forkeo");
    if (options.symlink) symlinkSync(join(app, "Forkeo"), executablePath);
