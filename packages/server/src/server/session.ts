...
export class Session {
  ...
  private async dispatchInboundMessage(msg: SessionInboundMessage, source?: object): Promise<void> {
    const promise =
      ...
      this.dispatchAgentMessage(msg, source) ??
  ...
  private dispatchAgentMessage(
    ...
    return (
      ...
      this.dispatchAgentContinuationMessage(msg)
    );
  }
  ...
  private dispatchAgentContinuationMessage(msg: SessionInboundMessage): Promise<void> | undefined {
    switch (msg.type) {
